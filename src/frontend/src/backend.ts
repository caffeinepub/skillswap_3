...
export class Backend implements backendInterface {
    ...
    async createLesson(arg0: string, arg1: string, arg2: Uint8Array, arg3: bigint): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async getLessonsByCreator(arg0: Principal): Promise<Array<Lesson>> {
        if (this.processError) {
            try {
                const result = await this.actor.getLessonsByCreator(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        name: value.name,
        gmail: record_opt_to_undefined(from_candid_opt_n13(_uploadFile, _downloadFile, value.gmail)),
        profileCreatedAt: value.profileCreatedAt,
        remainingLearningCredits: value.remainingLearningCredits
    };
}
